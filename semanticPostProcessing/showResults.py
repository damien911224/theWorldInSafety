...
#                 print j, result[j]
#                 box_colors = (254, 0, 254)
#             else:
#                 box_colors = (254, 254, 254)
#             cv2.rectangle(imgcv, (tl_x, tl_y), (br_x, br_y), box_colors, thick)
#             cv2.putText(imgcv, ("{0} {1:.2f}".format(label, confidence)), (tl_x, tl_y - 12), 0, 1e-3 * height, box_colors,
#                         1)
#
#             #path = path.split('/')[-1]
