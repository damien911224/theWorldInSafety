...
parser.add_argument('--dataset', type=str, choices=['ucf101', 'hmdb51', 'twis'], default='twis')
...
parser.add_argument('--save_scores', type=str, default="scores", help='the filename to save the scores in')
parser.add_argument('--num_worker', type=int, default=1)
parser.add_argument("--caffe_path", type=str, default='/home/damien/temporal-segment-networks/lib/caffe-action', help='path to the caffe toolbox')
...
modality = "rgb"
frame_path = "/media/damien/DATA/cvData/TSN_data/TWIS/opticalFlow/"
net_proto = "/home/damien/temporal-segment-networks/models/twis/tsn_bn_inception_rgb_deploy.prototxt"
net_weights = "/home/damien/temporal-segment-networks/models/twis_caffemodels/twis_split1_tsn_rgb_bn_inception_iter_3500.caffemodel"
