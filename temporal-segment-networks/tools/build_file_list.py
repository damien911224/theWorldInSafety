...
parser.add_argument('--dataset', type=str, choices=['ucf101', 'hmdb51', 'twis', 'activitynet_1.2', 'activitynet_1.3'])
...
parser.add_argument('--out_list_path', type=str, default='/home/damien/temporal-segment-networks/data/twis_parsed/optical_flow/')
