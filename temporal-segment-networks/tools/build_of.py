...
def run_optical_flow(vid_item, dev_id=0):
    ...
    if os.path.exists(out_full_path):
        print '{} {} skipped as already done'.format(vid_id, vid_name)
        return True
...
if __name__ == '__main__':
    ...
    # src_path = "/media/damien/DATA/cvData/UCF-101"
    # out_path = "/media/damien/DATA/cvData/TSN_data/UCF-101/opticalFlow"
    src_path = "/media/damien/DATA/cvData/TWIS"
    out_path = "/media/damien/DATA/cvData/TSN_data/TWIS/opticalFlow"
