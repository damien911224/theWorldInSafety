...
def makeTrainList():
    v_file_list = glob.glob("/media/damien/DATA/cvData/TWIS/v2/"+ "Violence/*.avi")
    n_file_list = glob.glob("/media/damien/DATA/cvData/TWIS/v2/" + "Normal/*.avi")
    ...
    for i in range(0, num_of_splits):
        ...
        n_train_indices = random.sample(range(0, (len(n_file_list)-1)), int(len(n_file_list)*0.90*ratio_of_normal_to_violence))
        n_test_indices = []
...
def changeFilesWithIds():
    ...
    dst_folder = '/media/damien/DATA2/cvData/TWIS/v2'
    frame_src_folder = '/media/damien/DATA/cvData/TSN_data/TWIS/v2'
    frame_dst_folder = '/media/damien/DATA2/cvData/TSN_data/TWIS/v2'
