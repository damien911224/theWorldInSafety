...
def parse_twis_splits():
    class_ind = [x.strip().split() for x in open('/home/damien/temporal-segment-networks/data/twis_splits/classInd.txt')]
    class_mapping = {x[1]:int(x[0])-1 for x in class_ind}
    ...
    splits = []
    for i in xrange(1, 4):
        train_list = [line2rec(x) for x in open('/home/damien/temporal-segment-networks/data/twis_splits/trainlist{:02d}.txt'.format(i))]
        test_list = [line2rec(x) for x in open('/home/damien/temporal-segment-networks/data/twis_splits/testlist{:02d}.txt'.format(i))]
        splits.append((train_list, test_list))
    return splits
